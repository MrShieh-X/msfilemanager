package com.mrshiehx.file.viewer.widgets;
 ...
 * 能缩放的ImageView
 *
 * @author CSDN（https://blog.csdn.net）@森森先生666（https://blog.csdn.net/qq_28643195）
 * @from https://blog.csdn.net/qq_28643195/article/details/107933754
 */
public class ProfessionalImageView extends AppCompatImageView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public ProfessionalImageView(Context context) {
        this(context, null);
    }

    public ProfessionalImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ProfessionalImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if (onClickListener != null)
                    onClickListener.onClick(ProfessionalImageView.this);
                return true;
            }
        });
